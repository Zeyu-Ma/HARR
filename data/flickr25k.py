...
def load_data(root, num_query, num_train, batch_size, num_workers):
    ...
    train_dataset = Flickr25k(root, 'train', train_transform(), transform_aug = train_aug_transform())
    train_dataset_wag = Flickr25k(root, 'train', query_transform())
...
class Flickr25k(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img_aug_1, img_aug_2, self.targets[index], index
