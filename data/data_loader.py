...
def load_data(dataset, root, num_query, num_train, batch_size, num_workers):
    ...
    if dataset == 'cifar-10':
        ...
        query_dataloader, train_dataloader, retrieval_dataloader, train_dataloader_wag = nuswide.load_data(21,
                                                                                     root,
                                                                                     num_query,
                                                                                     num_train,
                                                                                     batch_size,
        ...
        query_dataloader, train_dataloader, retrieval_dataloader, train_dataloader_wag = flickr25k.load_data(root,
                                                                                       num_query,
                                                                                       num_train,
                                                                                       batch_size,
                                                                                       num_workers,
